*Intro: Rails is very good for developing web application. I created this simple blog with help of ruby on rails community on worldwide. Thanks.

*License: All source code follows each gem's LICENSE. Other than that, rest codes follows RUBY license.( https://www.ruby-lang.org/en/about/license.txt)


I added and implemented search(solr),pagination(kaminari),url_rewrite(friendly_id) and user authentication(devise) and some bootstrap3 for UI.
For post editor, I used tinymce gem.
...
*Todo: bootstrap and some jquery related things. I am not good at javascript. Somebody help me.
